...
assert(stable.name === "Fatura Boa" && stable.version === "0.8.0.1" && stable.version_name === "0.8.0", "stable production identity/version missing");
assert(dev.name === "Fatura Boa DEV" && dev.version === "0.8.0.2" && dev.version_name === "0.8.0-dev.3", "DEV identity/version missing");
