...
assert(stable.name === "Fatura Boa" && stable.version === "0.7.0.2" && stable.version_name === "0.7.0", "stable production identity/version missing");
assert(dev.name === "Fatura Boa DEV" && dev.version === "0.7.0.2" && dev.version_name === "0.7.0-dev.2", "DEV identity/version missing");
